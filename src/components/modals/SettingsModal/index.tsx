import { TFontSize, TSettings } from '@/app/problems/components/Playground';
...
const EDITOR_FONT_SIZES: TFontSize[] = ['12px', '13px', '14px', '15px', '16px', '17px', '18px'];
...
const SettingsModal: FC<Props> = ({ setSettings, settings }) => {
    return (
            ...
            <div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
                <div className='flex min-h-screen items-center justify-center px-4'>
                    ...
                    <div
                        ...
                        onClick={() => {
                            setSettings({ settingModalIsOpen: false });
                        }}
                    >
                            ...
                            <div className='mt-6 flex justify-between first:mt-0'>
                                ...
                                <div className='w-[170px]'>
                                    <div className='relative'>
                                        <button
                                            onClick={() => {
                                                setSettings({ dropDownIsOpen: !settings.dropDownIsOpen });
                                            }}
                                        ...
                                        >
                                            {settings.fontSize}
                                            <Choose>
                                                <When condition={settings.dropDownIsOpen}>
                                                    <BsChevronUp />
                                                </When>
                                                <Otherwise>
                                                    <BsChevronDown />
                                        ...
                                        <If condition={settings.dropDownIsOpen}>
                                            <ul
...
interface SettingsListItemProps {
    fontSize: TFontSize;
    selectedOption: TFontSize;
    handleFontSizeChange: (fontSize: TFontSize) => void;
}
